        ...
        for name, values in tree.items():
            ...
            if property.remote_ap:
                ...
                if property.relation == "many-to-one":
                    ...
                    alchemy_query = alchemy_query.select_from(access_points[remote_ap._table]).where(join_col1 == join_col2)
...
def query_select_to_alchemy(self, alchemy_query, access_point, properties):
    ...
    for name, sub_select in self.sub_selects.items():
        ...
        alchemy_query = alchemy_query.select_from(remote_ap._table).where(col1 == col2)
        alchemy_query = sub_select.to_alchemy(alchemy_query,  access_point, remote_ap.properties)
