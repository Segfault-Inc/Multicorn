# -*- coding: utf-8 -*-
#
# Multicorn documentation build configuration file, created by
...
htmlhelp_basename = 'Multicorndoc'
...
latex_documents = [
  ('index', 'Multicorn.tex', u'Multicorn Documentation',
   u'Ronan Dunklau, Florian Mounier', 'manual'),
]
...
man_pages = [
    ('index', 'multicorn', u'Multicorn Documentation',
     [u'Ronan Dunklau, Florian Mounier'], 1)
]
...
texinfo_documents = [
  ('index', 'Multicorn', u'Multicorn Documentation',
   u'Ronan Dunklau, Florian Mounier', 'Multicorn', 'One line description of project.',
   'Miscellaneous'),
]
