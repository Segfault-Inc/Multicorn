...
class Alchemy(AccessPoint):
    ...
    def _column_from_prop(self, prop):
        ...
        if prop.relation == "many-to-one":
            ...
            # Transpose the multicorn relation in alchemy if possible
    ...
    def view(self, multicorn_query):
        """ Only multicorn_queries of the form :
        ...
        self._table
        properties = multicorn_query.validate(self.properties)
        can, cants = multicorn_query.alchemy_validate(self, self.properties)
        if can:
