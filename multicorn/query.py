...
from multicorn.request import make_request_property
from multicorn.item import AbstractItem
...
class QueryChain(Query):
    ...
    >>> from multicorn.request import Condition
