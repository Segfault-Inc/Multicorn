...
Multicorn helpers for value casting.
...
def to_datetime(value):
    ...
    datetime.datetime(2010, 8, 4, 20, 34, 31,
        tzinfo=<multicorn.value.FixedOffsetTimeZone object at ...>)
...
def to_bytes(value, encoding="utf-8"):
    ...
    This function works with Python 2.x and 3.x and can be used in Multicorn.
